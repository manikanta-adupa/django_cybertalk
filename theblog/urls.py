...
# from . import views
from .views import HomeView, ArticleDetailView,AddPostView,UpdatePostVew,DeletePostView, AddCategorytView,CategoryView, CategoryListView, LikeView, AddCommentView, SearchView
urlpatterns = [
    ...
    # path('analyze/',analyze_website,name='analyze_website'),
]